...
- `cross-law-rag-eval.json` contains 10 cases that require both the labor-law and insurance-law indexes. These cases check cross-corpus routing and exact source/article recall.
